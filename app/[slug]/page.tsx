...
function DetailPage() {
  ...
  return (
    ...
    //           <EditorNormal value={htmlValue} onChange={onChangeHtml} language='html' />
    //         </TabsContent>
    //         <TabsContent value='css'>
    //           <EditorNormal value={cssValue} onChange={onChangeCss} language='css' />
    //         </TabsContent>
    ...
    //         <Button onClick={runCode} className='w-fit'>
    //           Run Code
    //         </Button>
    ...
    //       <div className='h-1/5 mt-4 bg-black text-white p-2 overflow-auto'>
    //         <h3 className='text-sm font-bold'>Console Output:</h3>
    //         {logs.map((log, index) => (
    ...
    //   </div>
    // </div>
    <div className='flex flex-col items-center p-4 bg-gray-900 text-gray-100 h-screen'>
      <div className='flex gap-6 w-full h-full'>
        ...
        <div className='w-1/2 flex flex-col h-full'>
          ...
          <div className='flex-grow flex flex-col bg-gray-800 p-4 rounded-lg shadow-lg'>
            ...
            <div className='bg-gray-900 flex-grow border border-gray-700 rounded'>
              <iframe title='Preview' srcDoc={srcDoc} className='w-full h-full' />
            </div>
          </div>
